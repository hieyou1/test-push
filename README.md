...
In case you don't have push infrastructure ready, the [web-push CLI](https://github.com/web-push-libs/web-push#command-line) works well and is easy to set-up.
